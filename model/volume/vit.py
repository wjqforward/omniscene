...
class ViT(BaseModule):
    ...
    def __init__(self,
        ...
        elif isinstance(img_size, list) or isinstance(img_size, tuple):
            input_size = (img_size[0] // patch_size, img_size[1] // patch_size)
        else:
            raise ValueError("img_size must be int or list or tuple")
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            if 'model' in ckpt:
                ...
                _state_dict = ckpt
            if self.in_chans != 3:
                _state_dict.pop("patch_embed.proj.weight")
